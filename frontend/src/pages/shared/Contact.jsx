...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await api.post(`${API_URL}/api/contact`, formData);
      if (res.data.success) {
        setSuccess(true);
            ...
            <div className={s.contactInfoCard}>
              <div className={`${s.contactItem} ${s.contactItemMarginBottom}`}>
                ...
                <div>
                  ...
                  <div className={s.contactDetail}>support</div>
                </div>
              </div>
            ...
            {success ? (
              <div className={s.successContainer}>
                ...
                <p className={s.successMessage}>
                  Thank You for reaching out. We've your ,message and fill get
                  back to you shortly.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className={s.form}>
                ...
                <div className={s.inputGroup}>
                  <label className={s.label}>
                    <HiOutlineUser size={16} className="mr-1" /> Message
                  </label>
                  <textarea
                    name="message"
                    required
