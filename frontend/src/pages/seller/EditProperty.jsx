...
const EditProperty = () => {
  ...
  useEffect(() => {
    const fetchProperty = async () => {
      try {
        ...
        console.log("FULL PROPERTY RESPONSE:", p);
        console.log("AMENITIES FROM BACKEND:", p.amenities);
        console.log("AMENITIES TYPE:", typeof p.amenities);
        ...
        setFormData({
          ...
          amenities: Array.isArray(p.amenities)
            ? p.amenities.filter(Boolean)
            : [],
          securityDeposit: p.securityDeposit || "",
          maintenance: p.maintenance || "",
        });
        (setExistingImages(p.images || []), setLoading(false));
      } catch (error) {
        console.error(error);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.put(`${API_URL}/api/property/${id}`, data, {
        headers: {
        ...
        <form onSubmit={handleSubmit} className={s.formContainer}>
          ...
          <div className={s.section}>
            ...
            <div className={s.sectionContent}>
              <div>
                <label className={s.label}>Propery Title</label>
                <input
                  type="text"
                  name="title"
