...
export const myPropertiesStyles = {
  ...
  content: "mb-8",
  errorBox:
    "bg-red-100 text-red-600 px-4 py-3 rounded-md mb-4 border border-red-300",
  // Empty state
  emptyCard: "card-premium py-24 px-8 text-center",
  emptyIconWrapper:
...
export const propertyDetailsStyles = {
  ...
  additionalDetails:
    "additional-details bg-white p-8 rounded-[1.5rem] border border-[#f1f5f9] mt-12 mb-12 min-w-0",
...
export const registerStyles = {
  ...
  container: "container flex justify-center items-center px-24",
